...
import { TransactionImpliedEvComponent }  from './transaction-implied-ev.component';;

describe('TransactionDealDataComponent', () => {
  let component: TransactionImpliedEvComponent;
  let fixture: ComponentFixture<TransactionImpliedEvComponent>;

  beforeEach(() => {
    const valuationModelServiceStub = () => ({});
    TestBed.configureTestingModule({
      schemas: [NO_ERRORS_SCHEMA],
      declarations: [TransactionImpliedEvComponent],
      providers: [
        {
    ...
    fixture = TestBed.createComponent(TransactionImpliedEvComponent);
