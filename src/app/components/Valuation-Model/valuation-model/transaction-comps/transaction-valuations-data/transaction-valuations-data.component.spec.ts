...
import { TransactionValuationsDataComponent } from './transaction-valuations-data.component';
describe('financialDataValidator',() => {
    let component: TransactionValuationsDataComponent;
  let fixture: ComponentFixture<TransactionValuationsDataComponent>;
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ TransactionValuationsDataComponent ],
      providers: [
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TransactionValuationsDataComponent);
