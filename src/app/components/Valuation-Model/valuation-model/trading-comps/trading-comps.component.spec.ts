...
import {
  ...
  import { TradingCompsComponent } from './trading-comps.component';
import { of } from 'rxjs';
describe('financialDataValidator',() => {
    let component: TradingCompsComponent;
  let fixture: ComponentFixture<TradingCompsComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ TradingCompsComponent ],      
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TradingCompsComponent);
    component = fixture.componentInstance;
    myService = TestBed.inject(ValuationModelService);
    impService = TestBed.inject(ImpliedEvService);
  ...
  it('rowDataTranscomps', () => {
    expect(component.rawDataTradingComps).toEqual([]);
  });
  describe('getRawDataTransComps', () => {
    it('makes expectd call', () =>{
     ...
     component.getRawDataComps() 
     expect(component.rawDataTradingComps).toEqual(datas.data);
