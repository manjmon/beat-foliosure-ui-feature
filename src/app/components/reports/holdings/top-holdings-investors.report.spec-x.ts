...
import { NO_ERRORS_SCHEMA,SimpleChanges,ChangeDetectorRef } from "@angular/core";
...
describe("TopHoldingsInvestorsComponent", () => {
  let component: TopHoldingsInvestorsComponent;
  let fixture: ComponentFixture<TopHoldingsInvestorsComponent>;
  ...
  beforeEach(() => {
    ...
    const investorServiceStub = () => ({
      getAllInvestorsList: () => ({ subscribe: f => f({}) })
    });
    TestBed.configureTestingModule({
      imports: [FormsModule, MatMenuModule],
      schemas: [NO_ERRORS_SCHEMA],
      declarations: [TopHoldingsInvestorsComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(TopHoldingsInvestorsComponent);
  ...
  it(`topholdingReportId has default value`, () => {
    expect(component.topholdingReportId).toEqual(
      ReportCategory.HoldingsInvestors
    );
  });
  ...
  it(`reportID has default value`, () => {
    expect(component.reportID).toEqual(55);
  });
  ...
  describe("ngOnInit", () => {
    it("makes expected calls", () => {
      spyOn(component, "loadInvestorList").and.callThrough();
      spyOn(component, "getReportItems").and.callThrough();
      spyOn(component, "getReportMasterData").and.callThrough();
      component.ngOnInit();
      expect(component.loadInvestorList).toHaveBeenCalled();
      expect(component.getReportItems).toHaveBeenCalled();
      expect(component.getReportMasterData).toHaveBeenCalled();
    });
  });

  describe("loadInvestorList", () => {
    it("makes expected calls", () => {
      const investorServiceStub: InvestorService = fixture.debugElement.injector.get(
        InvestorService
      );
      spyOn(investorServiceStub, "getAllInvestorsList").and.callThrough();
      component.loadInvestorList();
      expect(investorServiceStub.getAllInvestorsList).toHaveBeenCalled();
    });
  });
  ...
  describe("onPcStatusChanged", () => {
    it("makes expected calls", () => {
      spyOn(component, "dataChangeCheck").and.callThrough();
      spyOn(component, "allLabelSelectionPlusCount").and.callThrough();
      spyOn(component, "onPcStatusChanged").and.callThrough();
      component.onPcStatusChanged();
      expect(component.dataChangeCheck).toHaveBeenCalled();
      expect(component.allLabelSelectionPlusCount).toHaveBeenCalled();
      expect(component.onPcStatusChanged).toHaveBeenCalled();
    });
  });
